...
// and set the properties notificationText, campaignId, contentUrl, imageUrl & videoUrl
- (void)extractCampaignFieldsFromNotification:(NSDictionary *)userInfo;

- (void)setPushAppsSdkKey:(NSString *)sdkKey andAppGroupName:(NSString *)appGroupName;
